...
(doi:10.17605/OSF.IO/NZXRV) and established non-inferiority without
superiority. The corpora accompany the article as Online Resource~1.
...
than independent samples, and with one corpus of our own the design cannot say
which of its properties matters. We make no claim that author-built benchmarks
inflate results in general. An earlier unpublished two-corpus analysis
motivated this study; the additional corpora and common evaluation protocol
did not support its conditional vocabulary-gap interpretation.
